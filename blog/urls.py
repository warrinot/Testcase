...
urlpatterns = [
    ...
    path('post/update/<int:pk>', login_required(views.PostUpdateView.as_view()), name='post_update'),
    path('post/delete/<int:pk>', login_required(views.PostDeleteView.as_view()), name='post_delete'),
